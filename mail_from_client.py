...
msg_benign.add_header('X-ASN', 'AS12345')
msg_benign.add_header('X-AS-NAME', 'example ASN')
msg_benign.add_header('Received-SPF', f'{spf_result} receiver={receiver_email}; client-ip=192.0.2.1; envelope-from={sender_email}; helo=mail.sender.com;')
...
msg_malicious.add_header('X-ASN', 'AS12345')
msg_malicious.add_header('X-AS-NAME', 'example ASN')
msg_malicious.add_header('Received-SPF', f'{spf_result} receiver={receiver_email}; client-ip=192.0.2.1; envelope-from={sender_email}; helo=mail.sender.com;')
